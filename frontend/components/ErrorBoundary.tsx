        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Es ist ein unerwarteter Fehler aufgetreten. Versuchen Sie die
              Seite neu zu laden.
            </p>
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-300 text-gray-700 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-400"
              >
                Erneut versuchen
              </button>
            </div>
